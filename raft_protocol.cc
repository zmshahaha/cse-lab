...
marshall& operator<<(marshall &m, const install_snapshot_args& args) {
    // Your code here
    m << args.term << args.leaderId << args.lastIncludedIndex << args.lastIncludedTerm << args.offset << args.data << args.done;
    return m;
}

unmarshall& operator>>(unmarshall &u, install_snapshot_args& args) {
    // Your code here
    u >> args.term >> args.leaderId >> args.lastIncludedIndex >> args.lastIncludedTerm >> args.offset >> args.data >> args.done;
    return u; 
}
